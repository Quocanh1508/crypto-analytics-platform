...
# ---------------------------------------------------------------------------
up-streaming: ## Day: ingestion & streaming (Kafka, MinIO, Postgres, Producer/Consumer)
	$(COMPOSE) --profile streaming up -d zookeeper kafka minio postgres minio-init binance-producer binance-consumer
